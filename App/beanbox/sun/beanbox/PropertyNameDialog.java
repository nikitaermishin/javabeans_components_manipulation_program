...
public class PropertyNameDialog extends JDialog implements ActionListener {
    ...
    PropertyNameDialog(JFrame frame, Object source, String message, Class match, boolean readable) {
