...
public class EventTargetDialog extends JDialog implements Runnable, ActionListener {

    EventTargetDialog(JFrame frame, Wrapper sourceWrapper, Wrapper targetWrapper,
